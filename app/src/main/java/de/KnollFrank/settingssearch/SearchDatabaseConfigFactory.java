...
class SearchDatabaseConfigFactory {
    ...
    public static SearchDatabaseConfig createSearchDatabaseConfig() {
        ...
        return new SearchDatabaseConfigBuilder()
                .withFragmentFactory(getFragmentFactory(activitySearchDatabaseConfigs, fragmentFactory))
                .withRootPreferenceFragmentOfActivityProvider(getRootPreferenceFragmentOfActivityProvider(activitySearchDatabaseConfigs))
                .withFragment2PreferenceFragmentConverter(getFragment2PreferenceFragmentConverter(activitySearchDatabaseConfigs))
    ...
    private static FragmentFactory getFragmentFactory(final List<ActivitySearchDatabaseConfig<? extends AppCompatActivity, ? extends Fragment, ? extends PreferenceFragmentCompat, ? extends PreferenceFragmentCompat>> activitySearchDatabaseConfigs,
    ...
    private static Fragment2PreferenceFragmentConverter getFragment2PreferenceFragmentConverter(final List<ActivitySearchDatabaseConfig<? extends AppCompatActivity, ? extends Fragment, ? extends PreferenceFragmentCompat, ? extends PreferenceFragmentCompat>> activitySearchDatabaseConfigs) {
    ...
    private static RootPreferenceFragmentOfActivityProvider getRootPreferenceFragmentOfActivityProvider(final List<ActivitySearchDatabaseConfig<? extends AppCompatActivity, ? extends Fragment, ? extends PreferenceFragmentCompat, ? extends PreferenceFragmentCompat>> activitySearchDatabaseConfigs) {
