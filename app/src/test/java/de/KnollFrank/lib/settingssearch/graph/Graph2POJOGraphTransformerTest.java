...
import static de.KnollFrank.lib.settingssearch.SearchablePreferenceEntityScreenEntityGraphProvider1Test.makeGetPreferencePathWorkOnGraph;
...
public class Graph2POJOGraphTransformerTest extends AppDatabaseTest {
    ...
    private static PreferenceAndExpectedPredecessorOfPreference getPreferenceAndExpectedPredecessorOfPreference(
        ...
        final Set<SearchablePreferenceEntity> searchablePreferenceEntities = getPreferences(pojoGraphExpected.vertexSet());
        return new PreferenceAndExpectedPredecessorOfPreference(
                getDstPreference(searchablePreferenceEntities),
                getPreferenceConnectingSrc2Dst(searchablePreferenceEntities));
    }
    ...
    private static SearchablePreferenceEntity getPreferenceConnectingSrc2Dst(final Set<SearchablePreferenceEntity> searchablePreferenceEntities) {
        return getPreferenceById(searchablePreferenceEntities, PREFERENCE_CONNECTING_SRC_2_DST_ID);
    }

    private static SearchablePreferenceEntity getDstPreference(final Set<SearchablePreferenceEntity> searchablePreferenceEntities) {
        return getPreferenceById(searchablePreferenceEntities, DST_PREFERENCE_ID);
    }

    private static SearchablePreferenceEntity getPreferenceById(final Set<SearchablePreferenceEntity> searchablePreferenceEntities,
                                                                final int id) {
