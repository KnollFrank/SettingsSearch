...
public class SearchablePreferenceEntityDAOTest extends AppDatabaseTest {
    ...
    public void shouldGetPredecessorOfPersistedPreference() {
        ...
        // When
        final SearchablePreferenceEntity predecessorFromDb = preferenceFromDb.getPredecessor().orElseThrow();
    ...
    public void shouldGetChildrenOfPersistedPreference() {
        ...
        // When
        final Set<SearchablePreferenceEntity> childrenFromDb = parentFromDb.getChildren();
    ...
    public void shouldSearchWithinTitleSummarySearchableInfo_excludePreferenceFromSearchResults() {
        ...
        final SearchablePreferenceDAO dao = appDatabase.searchablePreferenceDAO();
        final String needle = "title";
        final SearchablePreferenceEntity someSearchablePreferenceEntity =
                createSomeSearchablePreference(
                        1,
                        Optional.empty(),
                        Optional.empty(),
                        ...
                        Optional.empty(),
                        Optional.empty());
        dao.persist(someSearchablePreferenceEntity);
        final IncludePreferenceInSearchResultsPredicate includePreferenceInSearchResultsPredicate =
                excludePreferenceFromSearchResults(someSearchablePreferenceEntity);
        ...
        // Then
        assertThat(getPreferences(preferenceMatches), not(contains(someSearchablePreferenceEntity)));
    }
