...
class SearchConfigurations {
    ...
    public static Bundle toBundle(final SearchConfiguration searchConfiguration) {
        ...
        bundle.putParcelable(ARGUMENT_REVEAL_ANIMATION_SETTING, searchConfiguration.getRevealAnimationSetting());
    ...
    public static SearchConfiguration fromBundle(final Bundle bundle) {
        ...
        searchConfiguration.setRevealAnimationSetting(bundle.getParcelable(ARGUMENT_REVEAL_ANIMATION_SETTING));
