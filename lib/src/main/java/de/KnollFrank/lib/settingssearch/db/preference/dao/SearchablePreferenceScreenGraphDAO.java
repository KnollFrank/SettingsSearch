...
public class SearchablePreferenceScreenGraphDAO {
    ...
    public static void persist(final Graph<PreferenceScreenWithHostClass, PreferenceEdge> source, final OutputStream sink) {
        ...
        POJOGraphDAO.persist(MapFromPojoNodesRemover.removeMapFromPojoNodes(pojoGraph), sink);
    }

    public static Graph<PreferenceScreenWithHostClassWithMap, PreferenceEdge> load(final InputStream source,
